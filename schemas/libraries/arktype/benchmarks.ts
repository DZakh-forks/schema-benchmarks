...
export default defineBenchmarks({
  ...
  types: {
    ...
    fromType: {
      style: "annotation",
      valid: ts`
        const __schema: Type<JsonSchemaOutputData> = type({ id: "number", name: "string", price: "number" });
      `,
      invalid: ts`
        const __schema: Type<JsonSchemaOutputData> = type({ id: "number", name: "string", price: "string" });
      `,
    },
  },
});
